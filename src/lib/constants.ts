...
export const DEMO_USERS: UserProfile[] = [
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=MalakFarouk&backgroundColor=e6f1ed',
    returnedCount: 2,
    isTrusted: true,
    goodwillPoints: 100,
  },
  {
    ...
    avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=MoshiraAdmin&backgroundColor=176b5b',
    returnedCount: 34,
    isTrusted: true,
    goodwillPoints: 650,
  },
...
export const INITIAL_SEED_ITEMS: Item[] = [
  ...
  // 2. MATCHING FOUND ITEM IN SCIENCE LAB (88% Match with Malak's Calculator!)
  {
    ...
    reportedBy: {
      ...
      role: 'student',
      grade: 'الصف العاشر - أ',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Sara&backgroundColor=e6f1ed',
      returnedCount: 3,
      isTrusted: true,
      goodwillPoints: 90,
    },
  ...
  // 8. LOST PENCIL CASE
  {
    ...
    reportedBy: {
      ...
      role: 'student',
      grade: 'الصف العاشر - ب',
      avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Omar&backgroundColor=e6f1ed',
      returnedCount: 0,
      isTrusted: false,
      goodwillPoints: 10,
    },
